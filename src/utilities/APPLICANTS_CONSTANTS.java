...
public class APPLICANTS_CONSTANTS {
    ...
    //ROW 3
    public static final int MOVE_LABEL_POSITION_X = FNAME_LABEL_POSITION_X + 75;
    ...
    public static final int PHONE_LABEL_POSITION_X = MOVE_TEXT_POSITION_X + TEXT_AREA_WIDTH + 50;
