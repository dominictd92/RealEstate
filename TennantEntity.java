...
public class TennantEntity {
    ...
    public TennantEntity(int ssn, String fName, String mName, String lName, Timestamp birthdate, String phoneNumber, String car, String workStatus, String rentersInsurance, BigDecimal rent, Timestamp leaseEndDate) {
        this.ssn = ssn;
        this.fName = fName;
        this.mName = mName;
        this.lName = lName;
