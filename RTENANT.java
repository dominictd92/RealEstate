 ...
 * @author bchar
 */
public class RTENANT extends javax.swing.JFrame {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try{
            ...
            String url = "jdbc:mysql://localhost:3306/ ";
            Connection conn = DriverManager.getConnection(DATABASE_CONSTANTS.URL, DATABASE_CONSTANTS.USERNAME, DATABASE_CONSTANTS.PASSWORD);
            String sql = "Insert into shd.tennant (ssn,f_name,m_name,l_name,birthdate,phoneNumber,car,workStatus,rentersInsurance,rent,leaseEndDate) values (?,?,?,?,?,?,?,?,?,?,?)";
            PreparedStatement pst = conn.prepareStatement(sql);

            if(txtTenNum.getText().equals(" ")) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            ...
            String sql = "UPDATE shd.tennant SET f_name=?,m_name=?,l_name=?,birthdate=?,phoneNumber=?,car=?,workStatus=?,rentersInsurance=?,rent=?,leaseEndDate=? where ssn="+value;
            PreparedStatement pst = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RTENANT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
